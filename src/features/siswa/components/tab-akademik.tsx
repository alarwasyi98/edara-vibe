...
import { kelasOptions } from '../data/data'
...
export function TabAkademik({ siswa }: TabAkademikProps) {
    ...
    const editFields: EditField[] = [
        ...
        { key: 'nisn', label: 'NISN', value: siswa.nisn, readOnly: true },
        {
            ...
            value: siswa.kelas,
            type: 'select',
            options: kelasOptions.map((k) => ({ label: k, value: k })),
        },
        { key: 'tahunMasuk', label: 'Tahun Masuk', value: siswa.tahunMasuk },
        {
            key: 'status',
            label: 'Status',
            value: siswa.status,
    ...
    return (
        <>
            ...
            <EditDialog
                ...
                description='Perbarui data akademik siswa. NIS dan NISN bersifat read-only.'
                fields={editFields}
                open={editOpen}
